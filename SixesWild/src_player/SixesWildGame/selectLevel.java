...
public class selectLevel {
 ...
 private  JPanel selectLevelMenu;
 ...
 public  JPanel initialize() {
  ...
  btnLevel.addActionListener(
		    new ActionListener() {
		     public void actionPerformed(ActionEvent e) {
		    	 Application.toMenu(3);
		      	  
		     }});
  selectLevelMenu.add(btnLevel);
  ...
  selectLevelMenu.add(button_4);
  
  JButton button_5 = new JButton("7");
  button_5.setBounds(242, 104, 39, 29);
  selectLevelMenu.add(button_5);
  
  JButton button_6 = new JButton("8");
  button_6.setBounds(367, 104, 39, 29);
  selectLevelMenu.add(button_6);
